...
- Integrasi dengan **n8n + Google Gemini** untuk chatbot AI HPSBBot
...
| 🤖 Chatbot HPSBBot | Asisten AI berbasis n8n + Google Gemini untuk tanya stok & harga real-time |
...
- **n8n** — Workflow automation & AI agent (Chatbot HPSBBot)
- **Google Gemini 2.5 Flash** — AI model untuk chatbot
