...
<div class="wrapper">
    ...
    <div class="section" id="s3">
        ...
        <div class="team-grid">
            ...
            <div class="team-card">
                <div class="team-avatar" style="background-image: url('{{ asset('foto/tim/paiton.jpeg') }}'); color: transparent;">P</div>
                <div class="team-name">Paiton Wenda</div>
                <div class="team-role">Anggota Tim</div>
                <div class="team-npm">NPM: 20241320043</div>
                <div class="team-social">
                    <a href="https://www.instagram.com/paitonwenda02gmail.com7?igsh=MTdtNzU2ZHZqOGE4" target="_blank" title="Instagram">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                    </a>
                </div>
                <div class="team-tags">
